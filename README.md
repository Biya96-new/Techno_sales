This project showcases how Techno Sales Learning Services Company transitioned from using Microsoft Excel for data cleaning and reporting to Power BI, automating the entire sales analysis process. The goal was to streamline the workflow, reduce manual effort, and enhance the accuracy and speed of generating insightful reports.

**Project Overview**
The company previously relied on Microsoft Excel for cleaning data and creating sales reports, which was a time-consuming and manual process. To solve this issue, Power BI was introduced to:
Automate data analysis and reporting.

Provide real-time insights on sales across different dimensions (region, category, segment, state, year, etc).

Enable easy updates with a refresh button or scheduled refresh, eliminating the need for manual report updates.
...
Segment: Customer segment (e.g., individual, corporate).
State: The state where the sale was made.
Date: Date of the transaction.
Sales_Amount: Total amount of each sale.
